...
namespace HebrewTaskbarWidget
{
    public partial class MainWindow : Window
    {
        ...
        private void ToggleZmanimPopup()
        {
            ...
            // מעבירים את ה-HWND של הוידג'ט עצמו כ"חלון מוגן" נוסף - כך
            // שלחיצה חוזרת על הוידג'ט בזמן שהפופ-אפ פתוח לא תיחשב "לחיצה
            // בחוץ" (שהייתה סוגרת אותו ברקע ואז מיד פותחת אותו מחדש), אלא
            // תגיע לכאן ותסגור אותו כראוי (ראו הערה מפורטת ב-ZmanimPopup).
            IntPtr widgetHandle = new WindowInteropHelper(this).Handle;

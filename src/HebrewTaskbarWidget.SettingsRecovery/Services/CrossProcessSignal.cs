...
namespace HebrewTaskbarWidget.Services
{
    ...
    /// ההגדרות (HebrewTaskbarWidgetSettings.exe, תהליך נפרד לגמרי - גם
    /// אם מקומפל מאותה תיקיית קוד מקור בדיוק, ראו
    /// HebrewTaskbarWidget.SettingsRecovery.csproj) יוכל "לדבר" עם הוידג'ט
    /// הראשי אם הוא רץ ברקע: גם כדי שהגדרות שנשמרו

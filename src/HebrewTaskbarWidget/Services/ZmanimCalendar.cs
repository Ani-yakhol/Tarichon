...
namespace HebrewTaskbarWidget.Services
{
    ...
    /// צאת הכוכבים ב-8.5 מעלות/13.5 דקות), אך אינן פוסקות הלכה למעשה. בגרסה
    /// עתידית (פאנל ההגדרות, חלק 3) ניתן יהיה לבחור בין שיטות/דעות חילופיות.
    /// </summary>
    public static class ZmanimCalendar
    {
        ...
        public const string NameTzeitHakochavim = "צאת הכוכבים (8.5°)";
        ...
        /// גם בהגדרות ובכללי ההתראה) עבור רוב הזמנים, חוץ מ"עלות השחר" ו"צאת
        /// הכוכבים" - שם ה-"(16.1°)"/"(8.5°)" הטכני מוצג רק בהגדרות "מיקום
        /// וזמנים" (כדי לדייק בבחירה), אך מושמט בתצוגה היומיומית בפופ-אפ.
        /// </summary>
        public static string GetPopupDisplayName(string canonicalName)
        {
            ...
            if (canonicalName == NameTzeitHakochavim)
            {
                return "צאת הכוכבים";
            }
        ...
        public static IReadOnlyList<ZmanEntry> Calculate(DateTime date, GeoLocation location, int candleLightingMinutesBeforeSunset = 40)
        {
            ...
            entries.Add(new ZmanEntry { Name = NameTzeitHakochavim, Time = tzeitHakochavim });
